...
/*   
        PieChartUI.setChartType(PieChartUI.PeiChartType.DONUT_CHART);
        PieChartUI.addData(new PieChartUIModel("ສະແດງ", 150, new Color(23, 126, 238)));
        PieChartUI.addData(new PieChartUIModel("ABC", 100, new Color(221, 65, 65)));
        PieChartUI.addData(new PieChartUIModel("Coca", 1, new Color(47, 157, 64)));
        PieChartUI.addData(new PieChartUIModel("Vita", 60, new Color(196, 151, 58))); */
public class PieChartUI extends JComponent {

    private final List<PieChartUIModel> models;
    ...
    public PieChartUI() {
        ...
        setFont(new Font("Phetsarath OT", 0, 14));
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < models.size(); i++) {
            PieChartUIModel data = models.get(i);
    ...
    private double getTotalvalue() {
        double max = 0;
        max = models.stream().map(data -> data.getValues()).reduce(max, (accumulator, _item) -> accumulator + _item);
        return max;
    }
    ...
    public void addData(PieChartUIModel data) {
        models.add(data);
    }
