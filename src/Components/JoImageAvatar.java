...
public class JoImageAvatar extends JComponent {

    private Icon icon = new ImageIcon(getClass().getResource("/Resource/user_Image.jpg"));
    private int borderSize = 2;

    @Override
    protected void paintComponent(Graphics grphcs) {
        setForeground(JoTheme.Primary);
        if (icon != null) {
            int width = getWidth();
