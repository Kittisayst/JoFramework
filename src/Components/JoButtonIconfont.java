...
public final class JoButtonIconfont extends JButton {
...
//        setPreferredSize(new Dimension(120, 45));
    ...
    public Icon getJoIcon(GoogleMaterialDesignIcons IconName, int Size, Color color) {
        IconFontSwing.register(GoogleMaterialDesignIcons.getIconFont());
        Icon icon = IconFontSwing.buildIcon(IconName, Size, color);
        return icon;
    }
